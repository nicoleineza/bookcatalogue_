...
<html>
  <head>
    ...
    <style>
      ...
      #side-bar-options {
        padding: 0.7rem 2rem; /* Increase thickness of <li> */
      }
        ...
        <div class="col-md-3">
          ...
          <div id="side-bar" class="list-group">
            <a href="#" class="list-group-item list-group-item-action"
              >To Be Read</a
            >
            <a href="#" class="list-group-item list-group-item-action">Read</a>
            <a href="#" class="list-group-item list-group-item-action"
              >Currently Reading</a
            >
        ...
        <div class="col-md-9">
          <div class="row">
            <div class="col-md-3">
              <div class="card">
                <img
                  src="https://m.media-amazon.com/images/I/81IV--KF2yL._AC_UF1000,1000_QL80_.jpg"
                  class="card-img-top"
                  alt="Book Image"
                />
                <div class="card-body">
